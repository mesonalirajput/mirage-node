...
**Next focus:** Plan 06 — sub-plans 06.1 (Profile tokenization), 06.2 (globals component restyle), 06.3 (Follows / Blocks / Reports), and 06.4 (Network + Stats) are ✅ done. Sub-plan [`06-subplans/05-subscription-referrals.md`](./06-subplans/05-subscription-referrals.md) is 🟡 in progress — **Subscription ✅ done**, Referrals ⏳ next.
